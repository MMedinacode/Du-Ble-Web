...
const MENU = {
  ...
  "panaderia": {
    ...
    "items": [
      {
        "n": "Pan del día",
        "d": "Horneado en el local; es su rubro principal junto a la pastelería"
      }
    ]
  },
  "cafeteria": {
...
/* ---------- INDICADOR ABIERTO / CERRADO ----------
   ⚠️ Google confirma que CIERRA a las 20:30. La hora de apertura NO está publicada: se asume 09:00 como estimación y así se declara en Visítanos. */
